...
async function run(args){
    ...
    await doc.useServiceAccountAuth(creds)
    const sheet = await doc.addSheet({ title: 'test', headerValues: ['lowerBound', 'upperBound', 'UnixTime', 'dateTime', 'token0Balance', 'token1Balance', 'currentPrice', 'AAVECollateral', 'healthFactor', 'total'] })
