...
async function run(args){
    ...
    await doc.useServiceAccountAuth(creds)
    const sheet = await doc.addSheet({ title: 'hourly test', headerValues: ['lowerBound', 'upperBound', 'UnixTime', 'token0Balance', 'token1Balance', 'currentPrice', 'AAVECollateral', 'healthFactor', 'total'] })
