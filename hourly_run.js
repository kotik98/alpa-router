...
async function run(args){
    ...
    await doc.useServiceAccountAuth(creds)
    const sheet = await doc.addSheet({ headerValues: ['lowerBound', 'upperBound', 'UnixTime', 'token0Balance', 'token1Balance', 'currentPrice', 'AAVECollateral', 'healthFactor', 'total', 'it is hourly backtest'] })
